"""
OG paylaşım görselini üretir: web/frontend/public/og-image.png (1200x630).

Beyaz zemin (logo/emblem ile ayni stil). Sol tarafta emblem ikon blogu, sagda
"PDF PLATFORM" wordmark + iki tagline; sag altta pdfplatform.app.
...
tag1_font = ImageFont.truetype(bold, 40)
tag2_font = ImageFont.truetype(reg, 33)
tag1 = "Birleştir · Dönüştür · Sıkıştır · Düzenle"
tag2 = "Hızlı · Güvenli · Cihazında gizli"
