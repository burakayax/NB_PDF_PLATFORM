...
export const forgotPasswordTranslations: Record<Language, ForgotPasswordCopy> =
  {
    en: {
      ...
      stepEmailHint:
        "We will send a 6-digit code if an account exists with a password.",
    ...
    tr: {
      ...
      stepEmailHint:
        "Şifre ile kayıtlı bir hesap varsa 6 haneli kod gönderilir.",
      stepCodeTitle: "Kodu girin",
      stepCodeHint: "Gelen kutunuzdaki kodu yazın.",
      stepNewTitle: "Yeni şifre belirleyin",
      stepNewHint:
        "En az 10 karakter; büyük, küçük harf, rakam ve sembol kullanın.",
...
export const authTranslations: Record<Language, AuthCopy> = {
  en: {
    ...
    login: {
      title: "Sign in to NB PDF PLATFORM",
      description:
    ...
    register: {
      ...
      description:
        "Set up secure access for your web workspace and future desktop licensing.",
  ...
  tr: {
    ...
    login: {
      title: "NB PDF PLATFORM hesabınıza giriş yapın",
      description:
    ...
    register: {
      ...
      description:
        "Web çalışma alanınız ve ilerideki masaüstü lisans yapınız için güvenli erişimi başlatın.",
...
export function translateAuthApiMessage(
  message: string,
  language: Language,
): string {
  ...
  const map: Record<string, string> = {
    ...
    "Please verify your email address before continuing.":
      "Devam etmeden önce e-posta adresinizi doğrulayın.",
    ...
    "Session refresh token has expired.":
    ...
    "This account cannot reset password here.":
      "Bu hesap buradan şifre sıfırlayamaz.",
