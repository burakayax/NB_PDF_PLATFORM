...
const REGISTRY: Omit<WorkspaceFeatureUi, "title" | "description" | "buttonText">[] = [
  ...
  },
  {
    ...
    accept: ".doc,.docx,.docm,.dotx,.dotm,.odt,.rtf,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document",
    multiple: true,
  ...
  },
  {
    ...
    accept: ".xlsx,.xls,.xlsm,.xlsb,.xltx,.xltm,.ods,.csv,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet,application/vnd.ms-excel",
    multiple: true,
    fallbackFilename: "çıktı.pdf",
  },
  {
  ...
  },
  {
    ...
    icon: "📊",
    endpoint: "ppt-to-pdf",
    accept: ".ppt,.pptx,.pptm,.potx,.potm,.odp,application/vnd.ms-powerpoint,application/vnd.openxmlformats-officedocument.presentationml.presentation",
    multiple: true,
    fallbackFilename: "çıktı.pdf",
  },
  {
