...
export const PLANS: PlanDefinition[] = [
  ...
  },
  {
    ...
    featuresTr: [
      "Plus'taki her şey",
      "✨ Yapay zekâ: PDF Özetle, Veri Çıkar, Çeviri",
      "✨ PDF Karşılaştır, Hassas Veri Gizle, AI Toplu İşlem",
    ...
    featuresEn: [
      "Everything in Plus",
      "✨ AI: Summarize, Extract Data, Translate",
      "✨ Compare PDFs, Redact, AI Batch",
  ...
  },
  {
    ...
    displayMonthlyEquivalent: true,
    featuresTr: [
      "Pro'daki her şey (tüm yapay zekâ araçları dahil)",
    ...
    featuresEn: [
      "Everything in Pro (all AI tools included)",
