...
export const CHAIN_SUGGESTIONS: Partial<Record<FeatureId, FeatureId[]>> = {
  ...
  "form-doldur": ["flatten-pdf", "compress", "merge", "encrypt", "page-numbers"],
  "ustveri-temizle": ["compress", "encrypt", "watermark", "merge", "flatten-pdf"],
  "pdf-to-pdfa": ["compress", "merge", "page-numbers", "ustveri-temizle", "encrypt"],
  "sayfa-duzeni": ["compress", "page-numbers", "watermark", "merge", "encrypt"],
  "imza-iste": ["compress", "merge", "encrypt", "ustveri-temizle", "pdf-to-pdfa"],
...
export const CHAIN_RESULT_NOUN: Partial<Record<FeatureId, { tr: string; en: string }>> = {
  ...
  "form-doldur": { tr: "Doldurduğunuz form", en: "filled form" },
  "ustveri-temizle": { tr: "Temizlediğiniz PDF", en: "cleaned PDF" },
  "pdf-to-pdfa": { tr: "Arşive çevirdiğiniz PDF", en: "archived PDF" },
  "sayfa-duzeni": { tr: "Düzenlediğiniz PDF", en: "laid-out PDF" },
  "imza-iste": { tr: "İmzalattığınız belge", en: "signed document" },
