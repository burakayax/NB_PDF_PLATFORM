...
export const TOOL_CATEGORIES: ToolCategory[] = [
  {
    ...
    tools: [
      ...
      { id: "pdf-to-pdfa", icon: <Archive className="h-5 w-5" />, tr: "PDF/A Arşiv", en: "PDF/A archive" },
      { id: "sayfa-duzeni", icon: <Grid2x2 className="h-5 w-5" />, tr: "Sayfa Düzeni", en: "Page layout" },
      { id: "imza-iste", icon: <FileSignature className="h-5 w-5" />, tr: "İmza İste", en: "Request signature" },
