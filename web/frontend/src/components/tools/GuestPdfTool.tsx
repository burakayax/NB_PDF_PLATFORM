...
/**
 * MİSAFİR-ÖNCELİKLİ tam araç sayfası — login YOK. Çalışan araç çekirdeği
 * (GuestToolCore) + SEO içeriği (H1 + açıklama + SSS) görünür kalır →
 * sayfa hem arama hedefi hem çalışan araç.
 */
