...
function Hero({
  ...
  const isPage = isPageToolId(freeTool);

  return (
    <section
      className={`relative min-h-screen flex ${isPage ? "items-start" : "items-center"} justify-center pt-20 pb-16 px-5 sm:px-8 text-center overflow-hidden`}
    >
      <div className="relative z-10 max-w-5xl mx-auto">
        ...
        <motion.div
          {...stagger(3)}
          className={`mt-10 mx-auto w-full ${isPage ? "max-w-4xl" : "max-w-xl"}`}
        >
