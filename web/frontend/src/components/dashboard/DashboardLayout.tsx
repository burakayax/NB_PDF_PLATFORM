...
export function DashboardLayout({
  ...
  // Drawer açıkken arka plan (çalışma sayfası) scroll'unu KİLİTLE.
  // iOS Safari `body{overflow:hidden}`'ı yok sayar; tek güvenilir yöntem body'yi
  // `position:fixed` ile sabitlemek. Mevcut scroll konumu `top` offset'iyle korunur
  // ve drawer kapanınca geri yüklenir (aksi halde sayfa en üste sıçrar).
  useEffect(() => {
