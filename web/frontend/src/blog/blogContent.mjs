  ...
  post(
    ...
    },
    {
      ...
      blocks: [
        ...
        { t: "cta", title: "PDF'ten Kesit Al", x: "İstediğiniz alanı seçip PDF ya da görsel olarak kaydedin — cihazınızda, ücretsiz.", btn: "Aracı aç", tool: "/tools/pdf-kesit-al" },
    ...
    },
    {
      ...
      blocks: [
        ...
        { t: "cta", title: "Snip PDF to Image", x: "Select the area you want and save it as a PDF or an image — on your device, free.", btn: "Open the tool", tool: "/tools/pdf-kesit-al" },
