...
export const EN_BLOG_SLUGS = {
  ...
  "uyap-belge-yukleme-boyut-hatasi": "uyap-upload-size-error",
  "udf-dosyasi-nasil-acilir": "how-to-open-udf-files",
  "edevlet-belgelerini-tek-pdf-yapma": "combine-government-documents-into-one-pdf",
  "tc-kimlik-numarasi-gizleme-belge": "hide-id-numbers-in-documents",
  "vize-basvurusu-evrak-hazirlama": "prepare-visa-application-documents",
  "ihale-dosyasi-pdf-hazirlama": "prepare-a-tender-submission-as-pdf",
  "bordro-sayfalarini-ayirma": "split-payslips-per-employee",
  "osym-sinav-basvurusu-fotograf-boyutu": "exam-application-photo-size",
  "uyap-karari-word-e-aktarma": "court-decision-from-uyap-into-word",
  "universite-kayit-evraklarini-hazirlama": "prepare-university-enrolment-documents",
