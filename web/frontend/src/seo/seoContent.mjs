...
export const TOOL_SEO = {
  ...
  "gorsel-sikistir": {
    tr: T(
      ...
      [
        { q: "Görsel nasıl sıkıştırılır?", a: "Görsellerinizi yükleyin, kaliteyi ve en büyük kenarı seçip 'Sıkıştır' deyin; her görselin küçültülmüş halini indirin. İşlem cihazınızda yapılır." },
        { q: "Görselim sunucuya yüklenir mi?", a: "Hayır. Sıkıştırma tamamen tarayıcınızda çalışır; görseliniz internete hiç gönderilmez, %100 gizlidir." },
        { q: "Hangi formatları destekliyor?", a: "JPG, PNG ve WebP yükleyebilir; çıktıyı JPEG veya WebP olarak alabilirsiniz. WebP genellikle aynı kalitede daha küçük dosya verir." },
        { q: "Kalite düşer mi?", a: "Kalite kaydırıcısıyla dengeyi siz kurarsınız. %70 civarı çoğu fotoğrafta gözle fark edilmeyen kayıpla ciddi boyut düşüşü sağlar." },
        { q: "Görsel sıkıştırmak ücretsiz mi?", a: "Evet. Üyeliksiz ve ücretsizdir; kurulum gerekmez, doğrudan tarayıcıda çalışır. Aynı anda birden çok görsel işleyebilirsiniz." },
      ],
    ),
    en: T(
      "Compress Image — reduce image size, online and free",
      "Compress JPG, PNG and WebP images in your browser. Adjust quality and dimensions to shrink file size — your image never leaves your device, no signup, free.",
      "Compress Image",
      "Reduce the file size of your photos and images: adjust quality and the maximum dimension, re-encode as JPEG or WebP, and see the before/after size and savings instantly. Compression runs entirely in your browser (on your device) — your image is never uploaded. Ideal for email, WhatsApp and the web; no signup or installation needed.",
      ["compress image", "image compressor", "reduce image size", "compress jpg", "compress png", "online image compressor", "resize image"],
      [
        { q: "How do I compress an image?", a: "Upload your images, choose the quality and maximum dimension, and click 'Compress'; download the smaller version of each image. It happens on your device." },
        { q: "Is my image uploaded to a server?", a: "No. Compression runs entirely in your browser; your image is never sent to the internet and stays 100% private." },
  ...
  "gorsel-boyutlandir": {
    tr: T(
      "Görsel Boyutlandırma — resmi istediğin piksel ölçüsüne getir, ücretsiz",
      "JPG, PNG ve WebP görselleri istediğiniz piksel ölçüsüne getirin. Instagram, Facebook, X, LinkedIn ve YouTube için hazır ölçüler; Lanczos süzgeciyle net sonuç — görseliniz cihazınızdan çıkmaz.",
    ...
    en: T(
      ...
      "Resize JPG, PNG and WebP images to any pixel size. Ready-made sizes for Instagram, Facebook, X, LinkedIn and YouTube, with sharp Lanczos scaling — your image never leaves your device.",
      "Resize Image",
  ...
  "sayfa-duzeni": {
    tr: T(
      ...
      "Birden çok PDF sayfasını tek kâğıda sığdırın ya da çift taraflı yazdırıp katlandığında sırayla okunan kitapçık dizin. Cihazınızda çalışır, üyeliksiz ve ücretsiz.",
    ...
    en: T(
      ...
      "Fit several PDF pages onto one sheet, or impose a booklet that reads in order once printed double-sided and folded. Runs on your device, free and without sign-up.",
  ...
  "pdf-to-pdfa": {
    tr: T(
      ...
      "Belgenizi kurumların istediği ISO arşiv biçimi PDF/A'ya çevirin. Yazı tipleri belgenin içine gömülür; dosya yıllar sonra da aynı görünür. PDF/A-1b, 2b ve 3b desteklenir.",
    ...
    en: T(
      ...
      "Convert your document to PDF/A, the ISO archival format institutions ask for. Fonts are embedded so the file looks the same years from now. PDF/A-1b, 2b and 3b supported.",
