...
export const TOOL_SEO = {
  ...
  "pdf-duzenle": {
    tr: T(
      ...
      "PDF'teki mevcut yazının üstüne kutu çizin; o metin gerçekten silinsin ve yerine yenisini yazın (örtme değil, gerçek düzenleme). Yeni metin de ekleyebilirsiniz. Türkçe karakterler tam desteklenir; sonucu düzenlenmiş PDF olarak indirin. Not: belge cihazınızda açılır ve düzenlenir; yalnızca kaydettiğinizde gerçek düzenleme için güvenli sunucumuzda işlenir ve hemen silinir.",
      ...
      [
        ...
        { q: "Dosyam güvende mi?", a: "Evet. Belge cihazınızda açılır ve düzenlenir; yalnızca kaydettiğinizde gerçek metin düzenleme için güvenli sunucumuzda işlenir ve işlem biter bitmez silinir, saklanmaz. (Birleştirme, bölme, kırpma, imzalama, işaretleme, tarama ve OCR gibi araçlarımız ise tamamen cihazınızda çalışır.)" },
    ...
    en: T(
      ...
      "Draw a box over existing text in the PDF; it is truly deleted and you type a replacement (not a cover-up — real editing). You can also add new text. Download the edited PDF. Note: the document opens and is edited on your device; only when you save is it processed on our secure server for real editing, then deleted right away.",
      ...
      [
        ...
        { q: "Is my file safe?", a: "Yes. The document opens and is edited on your device; only when you save is it processed on our secure server for real text editing, then deleted right after — never stored. (Tools such as merge, split, crop, sign, annotate, scan and OCR do run entirely on your device.)" },
